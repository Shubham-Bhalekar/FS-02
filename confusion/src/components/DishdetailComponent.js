...
import { Card, CardImg, CardText, CardBody, CardTitle, Breadcrumb, BreadcrumbItem, Button, Col, Row, Label, ModalBody, ModalHeader, Modal } from "reactstrap";
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <Modal centered={true} isOpen={this.state.isCommentFormModalOpen} toggle={this.toggleCommentFormModal} >
